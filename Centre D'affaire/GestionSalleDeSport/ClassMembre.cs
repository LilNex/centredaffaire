...
namespace Centre_D_affaire.GestionSalleDeSport
{
    class ClassMembre
    {
        ...
        public ClassMembre(string NOm, string PRenom, string NUmero, DateTime DAteNaissance, int TElephone, string EMail, string ADresse, int COdPostal, string SEx, string SItuationFamillial)
        {
            this.Nom = NOm;
            this.Prenom = PRenom;
            this.Numero = NUmero;
        ...
        public bool Ajouter(ClassMembre Membre)
        {
        ...
        public bool Supprimer(ClassMembre Membre)
        {
